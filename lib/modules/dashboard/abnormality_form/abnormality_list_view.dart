...
class _AbnormalityListViewState extends State<AbnormalityListView> {
  ...
  Widget abnormalityCardView({Abnormality? abnormality}){
    return InkWell(
      onTap: (){
        showDialog(context: context, builder: (BuildContext context) => detailView(abnormality: abnormality));
      },
      child: Container(
  ...
  detailView({Abnormality? abnormality}){
    return Dialog(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    commonDetailRowView(title: "Request No",subTitle: abnormality?.requestNo ?? "-"),
                    commonVerticalSpacing(),
                    commonDetailRowView(title: "Created Date",subTitle: abnormality?.createdAt ?? "-"),
                    commonVerticalSpacing(),
                    commonDetailRowView(title: "Business Name",subTitle: abnormality?.businessName ?? "-"),
                    commonVerticalSpacing(),
                    commonDetailRowView(title: "Plant Name",subTitle: abnormality?.plantShortName ?? "-"),
                    commonVerticalSpacing(),
                    commonDetailRowView(title: "Company Name",subTitle: abnormality?.companyShortName ?? "-"),
                    commonVerticalSpacing(),
                    commonDetailRowView(title: "Department Name",subTitle: abnormality?.departmentName ?? "-"),
                    commonVerticalSpacing(),
                    commonDetailRowView(title: "Sub Department Name",subTitle: abnormality?.subDepartmentName ?? "-"),
                    commonVerticalSpacing(),
                    commonDetailRowView(title: "Machine Detail",subTitle: abnormality?.machineDetail ?? "-"),
                    commonVerticalSpacing(),
                    commonDetailRowView(title: "Parts Name",subTitle: abnormality?.partsName ?? "-"),
                    commonVerticalSpacing(),
                    commonDetailRowView(title: "Abnormality Title",subTitle: abnormality?.abnormalityTitle ?? "-"),
                    commonVerticalSpacing(),
                    commonDetailRowView(title: "Abnormality Type",subTitle: abnormality?.abnormalityType ?? "-"),
                    commonVerticalSpacing(),
                    commonDetailRowView(title: "Find User Name",subTitle: abnormality?.findUserName ?? "-"),
                    commonVerticalSpacing(),
                    commonDetailRowView(title: "Assigned Users",subTitle: abnormality?.assignUserData ?? "-"),
                    commonVerticalSpacing(spacing: 20),
                  ],
                ),
              ),
